...
def main():
    ...
    # RECORDING_DIR = "captured_images"
    # os.makedirs(RECORDING_DIR, exist_ok=True)
    # CURRENT_ID = datetime.now().strftime("%Y%m%d_%H%M%S")
    # image_path = f"{RECORDING_DIR}/image_{CURRENT_ID}.jpg"  # If this doesn't exist, will create blank image
